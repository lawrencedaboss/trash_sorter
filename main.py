...
def main():
    ...
    def spawn_item():
        ...
        image = pygame.image.load(os.path.join(ASSET_IMG_PATH, item_name))
    ...
    def spawn_answer():
        correct = pygame.image.load(os.path.join(ASSET_IMG_PATH, "check.png"))
        incorrect = pygame.image.load(os.path.join(ASSET_IMG_PATH, "x.png"))
